...
import com.banquesys.security.UserDetailsServiceImpl;
import com.banquesys.security.jwt.AuthEntryPointJwt;
import com.banquesys.security.jwt.AuthTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/actuator/**").permitAll()  // Prometheus metrics scraping
